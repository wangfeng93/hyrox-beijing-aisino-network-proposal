...
replace_once(
    ...
    '<meta name="description" content="航天信息面向 HYROX 上海站形成的赛事网络业务高可用保障策略。" />'
)
replace_once(
    '<title>HYROX 北京赛事 × 航天信息｜访谈后网络方案 V2</title>',
    '<title>HYROX 上海站 × 航天信息｜赛事网络保障方案</title>'
)
...
new_hero = '<section class="hero"><div class="hero-bg"></div><div class="hero-grid"></div><div class="container"><div class="hero-content"><div class="hero-badge"><span class="live-dot"></span> 上海站“网络保障”策略方案 V2 · “主动风险检查”增强版</div><h1>SHANGHAI<span class="outline">BUSINESS READY</span><span class="cn">HYROX 上海站网络保障策略</span></h1><p class="hero-copy">以“锐捷”为主要网络产品体系，由“航天信息”全国22个分中心为服务运维体系，本方案围绕上海世博展览馆 3 号馆，把“网络可达”升级为对“注册、计时、大屏、直播、媒体交付和赛事运营”的<strong>业务“高可用”保障</strong>。</p><div class="hero-actions"><a class="pill-btn primary" href="#topology">体验上海站动态拓扑</a><a class="pill-btn" href="#insights">查看上海设计基线</a></div></div><div class="event-strip"><div class="event-cell"><span>Event</span><strong>HYROX Shanghai</strong></div><div class="event-cell"><span>Date</span><strong>2026.10.31 — 11.01</strong></div><div class="event-cell"><span>Venue</span><strong>上海世博展览馆 3 号馆</strong></div><div class="event-cell"><span>Positioning</span><strong>业务可用承诺</strong></div></div></div><div class="hero-credit">赛事图片来源：<a href="https://hyrox.com/event/hyrox-shanghai-1031/" target="_blank" rel="noopener">HYROX 官方上海站页面</a></div></section>'
